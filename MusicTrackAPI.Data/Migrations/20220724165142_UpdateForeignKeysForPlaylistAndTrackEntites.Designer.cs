...
namespace MusicTrackAPI.Data.Migrations
{
    ...
    [Migration("20220724165142_UpdateForeignKeysForPlaylistAndTrackEntites")]
    partial class UpdateForeignKeysForPlaylistAndTrackEntites
    {
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Album", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 24, 16, 51, 41, 999, DateTimeKind.Utc).AddTicks(7343));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Playlist", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 7, 24, 16, 51, 41, 999, DateTimeKind.Utc).AddTicks(9106));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Track", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 7, 24, 16, 51, 42, 0, DateTimeKind.Utc).AddTicks(358));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 7, 24, 16, 51, 42, 0, DateTimeKind.Utc).AddTicks(1763));
