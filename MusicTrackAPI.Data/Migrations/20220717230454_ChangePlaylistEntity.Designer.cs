...
namespace MusicTrackAPI.Data.Migrations
{
    ...
    [Migration("20220717230454_ChangePlaylistEntity")]
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Album", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 17, 23, 4, 54, 731, DateTimeKind.Utc).AddTicks(4840));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Playlist", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 7, 17, 23, 4, 54, 731, DateTimeKind.Utc).AddTicks(6020));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Track", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 7, 17, 23, 4, 54, 731, DateTimeKind.Utc).AddTicks(7170));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 7, 17, 23, 4, 54, 731, DateTimeKind.Utc).AddTicks(8380));
