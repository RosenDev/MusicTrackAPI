...
namespace MusicTrackAPI.Data.Migrations
{
    ...
    [Migration("20220611224214_AddDefaultValueForCreatedAtField")]
    partial class AddDefaultValueForCreatedAtField
    {
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Album", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 11, 22, 42, 13, 960, DateTimeKind.Utc).AddTicks(10));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Playlist", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 22, 42, 13, 960, DateTimeKind.Utc).AddTicks(1090));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.Track", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 22, 42, 13, 960, DateTimeKind.Utc).AddTicks(2200));
            ...
            modelBuilder.Entity("MusicTrackAPI.Data.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 22, 42, 13, 960, DateTimeKind.Utc).AddTicks(3550));
